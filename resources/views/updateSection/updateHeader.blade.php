                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="col-sm col-md col-lg">
                        <div class="row">
                           ...
                           <form class="form" method='post' action="{{route('updateHeader.store')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="w-full shadow appearance-none rounded py-2 px-3"   name="image">
                                   @error('image')
                                      {{$message('image')}} 
                                   @enderror
